...
public class IrohaFXTest extends Application {
 ...
 */
    private GridPane addGridPane() {
        ...
        ImageView imageHouse = new ImageView(
                    new Image(IrohaFXTest.class.getResourceAsStream("graphics/house.png")));
        ...
        ImageView imageChart = new ImageView(
                    new Image(IrohaFXTest.class.getResourceAsStream("graphics/piechart.png")));
    ...
    private FlowPane addFlowPane() {
        ...
        for (int i=0; i<8; i++) {
            pages[i] = new ImageView(
                    new Image(IrohaFXTest.class.getResourceAsStream(
