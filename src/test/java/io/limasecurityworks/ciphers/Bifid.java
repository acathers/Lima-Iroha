...
public class Bifid {
    ...
    * 
    * Step 1: Convert text into a number string using the keysquare for each letter.
    * Step 2: Split the numbers into period length(key), row first, then column, then row, so on and so forth.
    * Step 3: Produce two new strings. One for all of the row digits, and one for the column digits.
    * Step 4: Begin building the unencrypted test, letter 1 will be charAt(0) of row string for the row in the square
    * and chatAt(0) of the column string for column of the square. 
    *
    */
